...
<body class="h-screen w-screen overflow-hidden select-none bg-slate-50 relative">
    ...
    <div class="absolute inset-0 z-40 flex items-center justify-center p-4 pointer-events-none">
        ...
        <div class="w-full max-w-6xl bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row pointer-events-auto max-h-[90vh]">
            ...
            <div class="w-full md:w-7/12 p-8 md:p-12 lg:p-16 flex flex-col justify-center items-center md:items-start overflow-y-auto">
