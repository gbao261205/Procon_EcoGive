...
<div class="w-full max-w-md mx-4">
    <div class="bg-white shadow-lg rounded-2xl px-8 py-10">
        <div class="mb-6 text-center">
            <h1 class="text-2xl font-bold text-emerald-600 mb-1">Tạo tài khoản EcoGive</h1>
            <p class="text-slate-500 text-sm">Tham gia cộng đồng chia sẻ vì một tương lai xanh</p>
        </div>
        ...
        <form id="registerForm" method="post" action="${pageContext.request.contextPath}/register" class="space-y-5">
            <div>
